...
geth-up:
	geth --dev --ipcpath config/ethereum/geth.ipc --http.corsdomain '*' --http --allow-insecure-unlock --rpc.allow-unprotected-txs --mine --miner.threads 1 --verbosity 5 --datadir "config/ethereum/" --unlock 0x506b5650aa8a9fded3b155743da23e9987f31fb8 --password config/ethereum/password
